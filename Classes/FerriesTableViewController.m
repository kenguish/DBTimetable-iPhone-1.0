...
#import "FerriesTableViewController.h"
#import "TwoWayTableViewController.h"

@implementation FerriesTableViewController
@synthesize routesDict, routes;

- (void)viewDidLoad {
	self.navigationItem.title = @"Disco Bay Ferry timetables";
	...
	routesDict = [[routesOfFile objectForKey: @"itemChildren"] objectAtIndex: 0];
